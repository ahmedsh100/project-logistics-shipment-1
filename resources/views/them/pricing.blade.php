  ...
  <main class="main">
    ...
    <section id="alt-pricing" class="alt-pricing section">
      ...
      <div class="container">
        ...
        <div class="mt-4 row gy-4 pricing-item featured" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
            <h3>Business Plan</h3>
          </div>
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
        ...
        <div class="mt-4 row gy-4 pricing-item" data-aos="fade-up" data-aos-delay="300">
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
            <h3>Developer Plan</h3>
          </div>
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
